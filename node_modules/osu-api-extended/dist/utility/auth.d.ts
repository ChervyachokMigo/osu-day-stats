...
export declare let cache_v1: string;
export declare let cache_v2: string;
export declare const set_v1: (v: string) => string;
export declare const set_v2: (v: string) => string;
export declare const re_login: () => Promise<boolean>;
